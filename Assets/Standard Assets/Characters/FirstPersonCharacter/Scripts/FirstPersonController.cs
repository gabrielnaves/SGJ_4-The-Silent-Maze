...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private bool slowWalk;
        ...
        void Update() {
            ...
            if (!m_CharacterController.isGrounded && !jumping && m_PreviouslyGrounded)
                m_MoveDir.y = 0f;
        ...
        void GetInput(out float speed) {
            ...
            speed = m_WalkSpeed;
            if (isRunning) speed = m_RunSpeed;
            if (slowWalk) speed = m_SlowWalkSpeed;
            ...
            if (isRunning != wasRunning && m_UseFovKick && m_CharacterController.velocity.sqrMagnitude > 0) {
                StopAllCoroutines();
        ...
        void ProgressStepCycle(float speed) {
            ...
            {
                m_StepCycle += (m_CharacterController.velocity.magnitude + (speed*(isRunning ? 1f : m_RunstepLenghten)))*
                             Time.fixedDeltaTime;
            }
            ...
            if (m_CharacterController.velocity.magnitude > 0 && m_CharacterController.isGrounded) {
                m_Camera.transform.localPosition =
                    m_HeadBob.DoHeadBob(m_CharacterController.velocity.magnitude +
                                    (speed*(isRunning ? 1f : m_RunstepLenghten)));
